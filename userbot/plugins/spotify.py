...
def file_check():
    ...
    if not os.path.exists(logo):
        urllib.request.urlretrieve(
            "https://github.com/LLXR/catuserbotfork/tree/custom-Resources/raw/master/Resources/Spotify/cat.png",
            logo,
        )
    if not os.path.exists(font_mid):
        urllib.request.urlretrieve(
            "https://github.com/LLXR/catuserbotfork/tree/custom-Resources/blob/master/Resources/Spotify/GoogleSans-Medium.ttf?raw=true",
            font_mid,
        )
    if not os.path.exists(font_bold):
        urllib.request.urlretrieve(
            "https://github.com/LLXR/catuserbotfork/tree/custom-Resources/blob/master/Resources/Spotify/GoogleSans-Bold.ttf?raw=true",
            font_bold,
        )
...
async def make_thumb(url, client, song, artist, now, full):
    ...
    try:
        ...
        myphoto = urllib.request.urlretrieve(
            "https://github.com/LLXR/catuserbotfork/tree/custom-Resources/raw/master/Resources/Spotify/SwagCat.jpg"
        )
